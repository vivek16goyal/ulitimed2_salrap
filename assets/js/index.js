...
"</ul>");
    $("#setting-menu").append("<li onclick='GetAppUserInfo();' class='ui-li-has-icon ui-first-child' ><a href='#appSetting-div'  data-transition='flip' style='background-color:#999; color:white;' class='ui-btn'><img style='margin-top:-7px;' src='assets/img/cog2.png' alt='USA' class='ui-li-icon'>App Setting</a></li>" + "<li onclick='changeAccount();' class='ui-li-has-icon ui-first-child' ><a href='#appchange-pass'  data-transition='flip' style='background-color:#999; color:white;' class='ui-btn'><img style='margin-top:-7px;' src='assets/img/cog2.png' alt='USA' class='ui-li-icon'>Change Password</a></li>");
    ...
    try {
        ...
        $("#menuList").html("<ul class='menu-items' style='left:-17vmin;'>" +
               ...
               "<li class='menu-item' title='SETTING'>" +
                   ...
                   "</div>" +
               "</li>" +
                "<li class='menu-item' title='' id='li3' onclick='exitAppMenu()'><div class='menu-header'><div class='menu-icon'><i class='fa'> <img src='assets/img/mnuEXIT.png' style='width:9vmin;' /></i></div><div class='menu-content'><span>Exit</span> </div><div class='menu-close'><i class='fa fa-times'></i></div></div>" +
...
// <a href="#DivordType"> here</a>.
// target: div#exitAppMenu.jqm ;
// window.location = "HomePage.html#Term-condition";
//}
...
//code by vivek:- terms and condition
function termscondition() {
    // $("#")
